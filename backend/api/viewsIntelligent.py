...
skills = [    "Kotlin", "Java", "Android Studio", "MVVM", "TypeScript", "JavaScript", "iOS", "Web",    "MySQL", "HTML", "CSS", "Git", "RESTful API Design", "JSON", "Node.js", "React",    "Angular", "Vue.js", "Redux", "Responsive Web Design", "Unit Testing", "CI/CD", "Docker",    "SQL", "NoSQL Databases", "Web Security", "Agile/Scrum", "Software Architecture",    "Debugging", "Performance Optimization", "DevOps", "GraphQL", "Flutter", "Swift",    "Rust", "C++", "PHP", "Ruby on Rails", "MongoDB", "Firebase", "AWS", "Azure", "Blockchain",    "Machine Learning", "Data Science", "Front-end Development", "Back-end Development",    "Full-stack Development", "UI/UX Design", "Java Spring Framework", "Kotlin Coroutines"]
languages = [    "Chinese", "English", "Malay", "Indian", "Spanish", "Japanese", "French", "German",    "Arabic", "Russian", "Portuguese", "Italian", "Turkish", "Polish", "Greek", "Vietnamese",    "Korean", "Dutch", "Swedish", "Norwegian", "Finnish", "Danish", "Hebrew", "Chinese (Mandarin)",    "Thai", "Indonesian", "Filipino", "Bengali", "Arabic (Modern Standard)", "Persian (Farsi)",    "Ukrainian"]
educationQualificationList = [    "PhD", "Master", "Degree", "Diploma", "High School", "Higher vocational education",    "Junior high school (inclusive) and below", "Associate Degree", "Vocational Certificate",    "Postgraduate Certificate", "Technical Certification", "Online Courses/Certificates", "GED"]
schoolStatusList = [    "graduated", "studying", "drop out of school", "On a Gap Year", "Recently Graduated",    "Transferred to Another School", "Continuing Education"]
preferWork = [    "android developer", "java developer", "kotlin developer", "android", "Mobile App Developer",    "Full Stack Engineer", "Front-end Developer", "Back-end Developer", "Game Developer",    "Web Designer", "UI/UX Designer", "Data Analyst", "Product Manager", "QA Engineer",    "DevOps Engineer", "Cloud Architect", "IT Support Specialist", "Software Engineer Intern"]
