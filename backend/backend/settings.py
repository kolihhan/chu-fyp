...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'chiajy04@gmail.com'  # replace with your Gmail address
EMAIL_HOST_PASSWORD = 'kyxr qasa vard rrps'  # replace with your Gmail password or app-specific password
